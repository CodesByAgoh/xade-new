...
function Section2() { 
  return (
    <div className='section2'>
        <span className='solution'>A</span>
        <span className='one__stop'> one stop</span>
        <span className='solution'> solution for all your finances</span>
        <h2 className='explore'>Explore all the financial features offered by xade
         ...
         <div className='all__cards'>
             ...
             <div>
                ...
                <div  className='learn__more'>
                    <a  className='learn__more'href='#'> Learn more</a>
                </div>
             </div>
